...
exports.withWSUpgradeRoot = exports.withWSCloseRoot = exports.withWSSendRoot = exports.withWSOpenRoot = exports.withWSConnectRoot = exports.WSInstrumentationContext = exports.WSInstrumentation = void 0;
        ...
        Object.defineProperty(this, "_patchSend", {
            ...
            value: (original) => {
                ...
                return function (data, options, callback) {
                    ...
                    const [root, links] = getRootLinks(exports.WSInstrumentationContext.SEND_ROOT);
        ...
        Object.defineProperty(this, "_patchClose", {
            ...
            value: (original) => {
                ...
                return function (...args) {
                    const [root, links] = getRootLinks(exports.WSInstrumentationContext.CLOSE_ROOT);
        ...
        Object.defineProperty(this, "_patchServerHandleUpgrade", {
            ...
            value: (original) => {
                ...
                return function (request, socket, upgradeHead, callback) {
                    ...
                    const [root, links] = getRootLinks(exports.WSInstrumentationContext.UPGRADE_ROOT, parentSpan);
    ...
    _patchConstructor(OriginalWebSocket) {
        ...
        const klass = class WebSocket extends OriginalWebSocket {
            constructor(address, protocols, options) {
                ...
                if (address != null) {
                    const [root, links] = getRootLinks(exports.WSInstrumentationContext.CONNECT_ROOT);
                ...
                this.once("open", () => {
                    const [root, links] = getRootLinks(exports.WSInstrumentationContext.OPEN_ROOT);
 ...
 */
exports.WSInstrumentationContext = Object.freeze({
    /**
...
function getRootLinks(contextKey, parentSpan = api_1.trace.getSpan(api_1.context.active())) {
    const links = [];
    const root = api_1.context.active().getValue(contextKey);
    if (root && parentSpan) {
 ...
 */
function withWSConnectRoot(callback) {
    return api_1.context.with(api_1.context.active().setValue(exports.WSInstrumentationContext.CONNECT_ROOT, true), callback);
}
exports.withWSConnectRoot = withWSConnectRoot;
/**
 * Makes all "WS open" spans created in the callback be root spans.
 * @param callback - The callback to execute.
 * @returns The result of the callback.
 */
function withWSOpenRoot(callback) {
    return api_1.context.with(api_1.context.active().setValue(exports.WSInstrumentationContext.OPEN_ROOT, true), callback);
}
exports.withWSOpenRoot = withWSOpenRoot;
/**
 * Makes all "WS send" spans created in the callback be root spans.
 * @param callback - The callback to execute.
 * @returns The result of the callback.
 */
function withWSSendRoot(callback) {
    return api_1.context.with(api_1.context.active().setValue(exports.WSInstrumentationContext.SEND_ROOT, true), callback);
}
exports.withWSSendRoot = withWSSendRoot;
/**
 * Makes all "WS close" spans created in the callback be root spans.
 * @param callback - The callback to execute.
 * @returns The result of the callback.
 */
function withWSCloseRoot(callback) {
    return api_1.context.with(api_1.context.active().setValue(exports.WSInstrumentationContext.CLOSE_ROOT, true), callback);
}
exports.withWSCloseRoot = withWSCloseRoot;
/**
 * Makes all "WS upgrade" spans created in the callback be root spans.
 * @param callback - The callback to execute.
 * @returns The result of the callback.
 */
function withWSUpgradeRoot(callback) {
    return api_1.context.with(api_1.context.active().setValue(exports.WSInstrumentationContext.UPGRADE_ROOT, true), callback);
}
exports.withWSUpgradeRoot = withWSUpgradeRoot;
